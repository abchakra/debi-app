...
const GuestDetails = () => {
    ...
    >
        ...
        {guest.isStudent ? <Typography variant="h5" sx={{ color: 'red' }}>Check Student ID</Typography> : null}
        {!guest.paid ? <Typography variant="h5" sx={{ color: 'red' }}>Not Paid</Typography> : null}
        <TextField
            type="text"
            id="name"
            label="Name"
